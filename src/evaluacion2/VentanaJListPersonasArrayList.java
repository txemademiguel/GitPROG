...
public class VentanaJListPersonasArrayList extends JFrame implements ActionListener,FocusListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaJListPersonasArrayList frame = new VentanaJListPersonasArrayList();
	 ...
	 * Create the frame.
	 */
	public VentanaJListPersonasArrayList() {
		setTitle("VentanaJListPersonasArrayList");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 1358, 300);
		...
		dcb.addElement("Ascendente");
		dcb.addElement("Descendente");
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (o == btnInsertar){
		  ...
		  for (int posicion=0; posicion < dlm.size(); posicion++) {
			...
			switch (opcion) {
			case "Ascendente":
				// ordeno el arrayList por dni en Ascendente
			  Collections.sort(arrayList);
				break;
			case "Descendente":
				// ordeno el arrayList por dni en Descendente
				Comparator<Persona> comparador = Collections.reverseOrder();
				Collections.sort(arrayList, comparador);
				break;
			case "Nombre":
				// ordeno el arrayList por nombre en Ascendente
				...
				break;
			case "Apellidos":
				// ordeno el arrayList por apellidos en Ascendente
				Collections.sort(arrayList, new Comparator<Persona>() {
					@Override
					public int compare(Persona p1, Persona p2) {
				...
				break;
			case "Fecha":
				// ordeno el arrayList por fecha en Ascendente
				Collections.sort(arrayList, new Comparator<Persona>() {
					@Override
					public int compare(Persona p1, Persona p2) {
