...
public class VentanaJListGruposSeleccionMultipleMover extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaJListGruposSeleccionMultipleMover frame = new VentanaJListGruposSeleccionMultipleMover();
	 ...
	 * Create the frame.
	 */
	public VentanaJListGruposSeleccionMultipleMover() {
		setTitle("VentanaJListGruposSeleccionMultipleMover");
		...
		lblTexto = new JLabel("Selecciona Elementos de una Lista y los Mueve a la otra");
