...
public class VentanaJListNumerosOrdenado extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaJListNumerosOrdenado frame = new VentanaJListNumerosOrdenado();
	 ...
	 * Create the frame.
	 */
	public VentanaJListNumerosOrdenado() {
		setTitle("VentanaJListNumerosOrdenado");
