...
public class VentanaJPasswordFieldFoco extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaJPasswordFieldFoco frame = new VentanaJPasswordFieldFoco();
	 ...
	 * Create the frame.
	 */
	public VentanaJPasswordFieldFoco() {
