...
public class MultiVentanaJPasswordFieldFoco extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MultiVentanaJPasswordFieldFoco frame = new MultiVentanaJPasswordFieldFoco();
	 ...
	 * Create the frame.
	 */
	public MultiVentanaJPasswordFieldFoco() {
		setTitle("VentanaJPasswordFieldFoco");
		...
		pwfContrasena.addFocusListener(new FocusAdapter() {
			@Override
			public void focusGained(FocusEvent e) {
				// cuando coja el Foco selecciono todo el texto
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(usuario.equals(usuariocorrecto) && contrasena.equals(contracorrecta)) {
			...
			VentanaHolaAceptar vh = new VentanaHolaAceptar();
			// le cambio el Title
			vh.setTitle("Bienvenido "+usuario);
			// cambio el valor de lblMensaje
			// le pongo el valor del usuario
			vh.lblMensaje.setText("Bienvenido "+usuario);
